...
namespace kmsl
{
	enum class TokenType
	{
		...
		/* Operators */
		PLUS, MINUS, MULTIPLY, DIVIDE, FLOOR, MODULO, ROOT, LOG, POWER,
		PLUS_ONE, MINUS_ONE,
		...
		ASSIGN,
		PLUS_ASSIGN, MINUS_ASSIGN, MULTIPLY_ASSIGN, DIVIDE_ASSIGN, MODULO_ASSIGN, FLOOR_ASSIGN, POWER_ASSIGN, ROOT_ASSIGN, LOG_ASSIGN,
		BIT_AND_ASSIGN, BIT_OR_ASSIGN, BIT_XOR_ASSIGN, BIT_LEFT_SHIFT_ASSIGN, BIT_RIGHT_SHIFT_ASSIGN,
